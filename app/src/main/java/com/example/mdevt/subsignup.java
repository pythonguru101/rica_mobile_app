...
public class subsignup extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#ffffff'>Last 10 RICA Agents Sign Up</font>"));
        navigationView.bringToFront();
        ActionBarDrawerToggle toggle=new ActionBarDrawerToggle(subsignup.this,drawerLayout,toolbar,R.string.navigation_drawer_open,R.string.navigation_drawer_close);
