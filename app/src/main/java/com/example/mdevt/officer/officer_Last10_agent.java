...
public class officer_Last10_agent extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private static final String JSON_URL = "http://54.228.50.10/api/v1/last10_sub_agent/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#ffffff'>Last 10 RICA Agent</font>"));
        navigationView.bringToFront();
        ActionBarDrawerToggle toggle=new ActionBarDrawerToggle(officer_Last10_agent.this,drawerLayout,toolbar,R.string.navigation_drawer_open,R.string.navigation_drawer_close);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            JSONArray sampleListArray = obj.getJSONArray("last10_subagents");

                            for (int i = 0; i <sampleListArray.length(); i++) {
                                JSONObject sampleObject = sampleListArray.getJSONObject(i);


                                Status status = new Status(sampleObject.getString("pk"), sampleObject.getJSONObject("fields").getString("name"),
